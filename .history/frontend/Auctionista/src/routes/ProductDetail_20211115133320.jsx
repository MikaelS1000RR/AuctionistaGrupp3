...
<div className="emptyDiv"></div>
   ...
   productById.imageUrl.split(",").map(( image ) => 
      ...
      <div className="infowrap">
        <p className="category-location" key="1">{productById.categoryId.name} • {productById.locationId.name}</p>
        <p className="product-title" key="2">{productById.title}</p>
        <p className="product-brand" key="3">{productById.brand}</p>
        <p className="description-price" key="4">Starting price</p>
        <p className="product-price" key="5">{productById.startingPrice}</p>
        <p className="description-condition" key="6">Condition</p>
        <p className="product-condition" key="7">{productById.condition}</p>
        <p className="description-details" key="8">Details</p>
        <p className="product-details" key="9">{productById.details}</p>
        <p className="description-endDate" key="10">Ends</p>
          <p className="product-endDate" key="11">End date: {productById.endDate}</p>
      </div>
