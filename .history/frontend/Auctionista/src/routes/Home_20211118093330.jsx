...
import { ProductContext, useProductContextProvider } from '../contexts/ProductContextProvider';
...
const Home = () => {
  ...
  const {  getProducts, setProductsBySearch, highestBidder, notFound } = useContext(ProductContext);
